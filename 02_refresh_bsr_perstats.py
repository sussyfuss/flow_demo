...
@note: This process will open an excel application where you will need to enter your CAC email certificate.  Once logged in, the data tables in the excel
...
def main():
    ...
    # secondary archiving
    path_sg9_archive = "\\\\f8nsi0000a\\Org\\org\\AF-Surgeon General\\AFMOA North\\AFMOA_AFMS Analytics\\1. Projects\\CY 2020\\200329_COVID_Contingency\\BSR_Perstats_CK"
